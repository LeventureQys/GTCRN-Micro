...
def main(args):
    ...
    model_path = "./gtcrn_micro/models/tflite/gtcrn_micro_full_integer_quant.tflite"
    ...
    for wav_name in tqdm(noisy_wavs):
        ...
        # TFLITE
        # ---
        x = stft.numpy()[None, ...].astype(np.float32)

        interpreter.resize_tensor_input(input_details[0]["index"], x.shape, strict=True)
        interpreter.allocate_tensors()
